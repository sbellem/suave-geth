...
type SuaveRuntime interface {
	...
	getAttestationVerificationReport() (types.IASResponse, error)
...
func (b *SuaveRuntimeAdapter) getAttestationVerificationReport(input []byte) (res []byte, err error) {
	...
	if iasResponse, err = b.impl.getAttestationVerificationReport(); err != nil {
		return
	}

	result, err = artifacts.SuaveAbi.Methods["getAttestationVerificationReport"].Outputs.Pack(iasResponse)
	if err != nil {
		err = errFailedToPackOutput
		return
	}
